...
<article id="chapter-8">
    ...
    <section>
        ...
        <a :href="require('../assets/images/chapter__8_image_3.png')" target="_blank" data-fancybox="gallery" class="figure">
            <img :src="require('../assets/images/chapter__8_image_3.png')" alt="" class="my-0">
        </a>
        <section>
            <header class="text-center">
                <h3>Comparison</h3>
    ...
    <section>
        <header>
            ...
            <a :href="require('../assets/images/chapter__8_image_4.png')" target="_blank" data-fancybox="gallery" class="figure">
                <img :src="require('../assets/images/chapter__8_image_4.png')" alt="" class="my-0">
            </a>
        </header>
        <div class="md-layout">
            <section class="md-layout-item md-size-50 md-small-size-100">
    ...
    <section>
        ...
        <section>
            ...
            <p><a rel="nofollow" href="http://www.chefhero.com" target="_blank" class="text-bold">ChefHero</a> is a one-stop shop where you can get all of that done.</p>
