...
<article id="chapter-6">
    ...
    <section>
        ...
        <p>For restaurants, specifically, there’s food consistency to worry about. Think about your restaurant’s signature dish. It’s fresh. It’s flavorful. Customers come back over and over because they crave it. Now think about how that would all change if the dish weren’t consistent every time a customer ordered it. Imagine if a customer came back, specifically for that dish, and got something other than what they expect-ed, what they’d had before. That’s why food consistency is vital to your customer service strategy and, ultimately, your success.</p>
        <p>So how do you ensure the kind of consistency that will have customers coming back over and over for their favorite dish-es? There are a lot of strategies you can employ<sup><a href="http://info.flavorseal.com/news-and-media/perspectives/consistency-in-foodservice-why-its-important-now-more-than-ever/" target="_blank">[24]</a></sup>.</p>
        <p>First, standardize your products and your process. Make sure you’re getting consistently fresh, high-quality ingredi-ents from your suppliers, and if you’re not, change suppliers. Eliminate variability in how different chefs create your dishes by documenting recipes and making sure everyone follows them.</p>
