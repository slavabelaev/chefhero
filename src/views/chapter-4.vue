...
<article id="chapter-4">
    ...
    <section>
        ...
        <section>
            ...
            <p>You can pay people to help you with this. But, to start, it’s probably best to at least do the initial setup yourself so that you understand how it works.</p>
            <p>So which directories and websites do you care about?</p>
        ...
        <a :href="require('../assets/images/chapter__3_image_1.png')" target="_blank" data-fancybox="gallery" class="figure">
            <img :src="require('../assets/images/chapter__3_image_1.png')" alt="" class="my-0">
        </a>
    </section>
    <section>
        ...
        <section>
            <h3>Custom vs CMS vs Website Builder</h3>
