...
<article id="chapter-1">
    <header>
        <h1>Restaurant budgeting: Getting your numbers right</h1>
    ...
    <section>
        ...
        <figure class="figure">
            <img src="/assets/images/chapter-1_1.png" alt="" class="figure-img">
            <figcaption class="figure-caption">Managers should be involved in setting the budgets they need to run their departments.</figcaption>
        </figure>
    </section>
    <section>
    ...
    <section>
        ...
        <p>Opening a restaurant from the ground up takes even more careful budgeting. While ambition, a good taste for food and a vision for a niche cuisine will help a new restaurant owner, no restaurant is going to open without capital — and lots of it<sup><a target="_blank" href="https://smallbusiness.chron.com/list-expenses-starting-restaurant-scratch-4580.html">[3]</a></sup>.</p>
        ...
        <figure class="figure">
            <img src="/assets/images/chapter-1_2.png" alt="" class="figure-img">
            <figcaption class="figure-caption">Opening a new, 90-seat restaurant, can run anywhere from <strong>$3,064 to $4,444</strong> per seat or <strong>$275k-$4000k</strong>.</figcaption>
        </figure>
