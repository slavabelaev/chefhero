...
<article id="chapter-11">
    ...
    <section>
        ...
        <p>First, choose a handle that’s easily recognizable and search-able, so guests have no problem finding you on the platform. Your restaurant name is a good place to start, and if it’s not available, add your city to the name. Example: @sweetgreen or @deepellumboston. Pro-tip: Both of those accounts kill it, so check them out if you need some inspiration. When you set up your account, make sure you set it up as a busi-ness account, and not a personal one. This will allow you to access Insights, Instagram’s suite of business-friendly analytics tools to see how your posts are performing and where there’s room for growth in your reach. Having a busi-ness account also makes it easier for diners to contact you through Instagram.</p>
        ...
        <a :href="require('../assets/images/chapter__11_image_2.jpg')" target="_blank" data-fancybox="gallery">
            <img :src="require('../assets/images/chapter__11_image_2.jpg')" alt="" class="figure">
        </a> 
    </section>
    <section>
        <h2>Who should post?</h2>
        <p>Once your Instagram is up and running, it’s time to deter-mine who should post to it.</p>
        <p>Ideally, posting should be the responsibility of a small hand-ful of staff who know how to take great photos, understand Instagram business best practices, and can nail the com-pany’s voice in captions and customer interactions. If you have someone in charge of marketing, this is a job for them.</p>
        <p>But don’t limit your Instagram posts to just your staff. En-courage customers to post photos they take at your restau-rant, then use your hashtag to find them and share the best on your own account. You can offer gift cards or discounts as an incentive to get customers posting great photos us-ing your hashtag with your location tagged, which will help spread the word about your restaurant online. A good ex-ample of this comes from a Dunkin’ Donuts campaign called “UpgraDDe Your Sandwich”<sup><a href="https://aaronallen.com/blog/restaurant-promotions/10-great-ways-for-restaurants-to-use-instagram" target="_blank">[37]</a></sup>. It encouraged followers to share pictures of their lunches that needed a “Dunkin’ Do-nuts upgrade” along with the hashtag #UpgraDDe. Select participants won gift cards to Dunkin’ Donuts.</p>
    </section>
    <section>
    ...
    <section>
        ...
        <p class="mb-0">Armed with the right tips and tricks, it’s easy to see that Ins-tagram is a powerful marketing tool — and that it isn’t nearly as scary as it might seem to a less-than-tech-savvy restaura-teur. Use this guide to create a restaurant Instagram account that will not only show off the great work you’re doing, but will inspire diners to become followers.</p>
        <a :href="require('../assets/images/chapter__11_image_6.jpg')" target="_blank" data-fancybox="gallery">
            <img :src="require('../assets/images/chapter__11_image_6.jpg')" alt="" class="figure mb-0">
        </a>
    </section>
</article>
</template>
